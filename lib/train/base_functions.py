...
def build_dataloaders(cfg, settings):
    ...
    data_processing_train = processing.XTrackProcessing(search_area_factor=search_area_factor,
                                                       output_sz=output_sz,
...
def get_optimizer_scheduler(net, cfg):
    ...
    if 'bat' in train_type:
        ...
        param_dicts = [
            {"params": [p for n, p in net.named_parameters() if "MeME" in n and p.requires_grad]}
        ]
