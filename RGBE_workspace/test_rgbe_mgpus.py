...
import lib.test.parameter.xtrack as rgbe_prompt_params
...
def run_sequence(seq_name, seq_home, dataset_name, yaml_name, num_gpu=1, epoch=60, debug=0, script_name='prompt'):
    ...
    if script_name == 'xtrack':
        ...
        ostrack = XTrack(params)  # "VisEvent"
        tracker = XTrack_RGBE(tracker=ostrack)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--script_name', type=str, default='xtrack', help='Name of tracking method(ostrack, prompt, ftuning).')
    ...
    if dataset_name == 'VisEvent':
        seq_home = '/home/zwu-guest123/RGBXTestDatasets/VisEvent/test'
